...
import { Ionicons } from '@expo/vector-icons'; // Thêm bộ icon có sẵn của Expo
...
// Component con để hiển thị từng dòng tính năng cho gọn code
...
const styles = StyleSheet.create({
  ...
  featureIconBox: {
    ...
    height: 50,
    borderRadius: 12,
    backgroundColor: 'rgba(10, 126, 164, 0.1)', // Màu xanh nhạt
    justifyContent: 'center',
    alignItems: 'center',
  },
  featureDesc: {
